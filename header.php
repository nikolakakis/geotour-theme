...
<div id="page" class="site">
    ...
    <nav id="fullscreen-menu" class="fullscreen-menu" aria-hidden="true">
        ...
        ?>        <!-- Language flags section (expandable container) -->
        <div class="menu-language-section">
            <div class="menu-flags-container">
                <div class="flag-item">
                    <a href="#" aria-label="English">
                        <img src="/wp-content/themes/geotour-theme/assets/graphics/en.png" alt="English" width="28" height="20">
                    </a>
                </div>
                <div class="flag-item">
                    <a href="#" aria-label="Ελληνικά">
                        <img src="/wp-content/themes/geotour-theme/assets/graphics/el.png" alt="Greek" width="28" height="20">
                    </a>
                </div>
