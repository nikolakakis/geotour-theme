            ...
            <div class="listing-map-controls">
                ...
                if (!empty($vtour_link)) : ?>
                    <a href="<?php echo esc_url($vtour_link); ?>" class="map-control-button map-control-vr" title="<?php esc_attr_e('Open Virtual Tour', 'geotour'); ?>">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/graphics/map-pins/panoramas.svg" alt="Virtual Tour" width="20" height="20">
                    </a>
                <?php endif; ?>
                ...
                if (!empty($video_path_value) && $marker_lat && $marker_lng) :
                    ...
                    <a href="<?php echo esc_url($video_path_url); ?>" class="map-control-button map-control-3d" title="<?php esc_attr_e('Play 3D Video Path', 'geotour'); ?>">
                ...
                if (!empty($tour_3d_value) && $marker_lat && $marker_lng) :
                    ...
                    <a href="<?php echo esc_url($tour_3d_url_constructed); ?>" class="map-control-button map-control-3d" title="<?php esc_attr_e('Start 3D Tour', 'geotour'); ?>">
