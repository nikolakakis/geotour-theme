<?php
/**
 * Template part for displaying custom listing map from ACF field
 * 
 * Displays a 100vw section with shortcode content from listing_map ACF field
 * Only shows if field contains what appears to be a shortcode
 *
 * @package Geotour_Mobile_First
 */

// Get the listing_map ACF field
$listing_map_content = get_field('listing_map');

// Check if field has content and appears to be a shortcode
if (!empty($listing_map_content) && is_string($listing_map_content)) {
    $trimmed_content = trim($listing_map_content);
    ...
    if (strpos($trimmed_content, '[') !== false && 
        ...
        if (!empty($processed_content) && 
            ...
            <section class="listing-custom-map-section">
        ...
        <?php } elseif (current_user_can('edit_posts')) { ?>
            ...
            <section class="listing-custom-map-section error">
                <div class="custom-map-container">
